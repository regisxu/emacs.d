...
;;; Font settings
;(set-default-font "-outline-Courier-normal-r-normal-normal-18-*-96-96-c-*-iso8859-1")
(set-default-font "-Adobe-Courier-Medium-R-Normal--20-140-100-100-M-110-ISO8859-1")

;; load cua-lite for shift select. 
;; File .emacs.d/site-lisp/cua-lite.el is modified, remove keybind for 
;; "C-s, C-a...." some keybind i don't like.
(if window-system
    (require 'cua-lite))
